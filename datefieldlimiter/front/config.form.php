...
if (empty($all_profiles)) {
    ...
    foreach ($all_profiles as $profile_id => $profile_name) {
        echo "<tr>";
        echo "<td>" . Html::entities($profile_name) . "</td>";
        ...
        foreach ($predefined_fields as $field_key => $field_label) {
            ...
            echo Html::entities($field_label);
            echo "</label>";
        }
        echo "</td>";

        echo "<td>";
        echo "<textarea name='profile_fields[$profile_id][custom]' rows='3' class='glpi_textarea' style='width:95%;'>" . Html::entities(trim($profile_custom_fields_text)) . "</textarea>";
        echo "</td>";
        echo "</tr>";
    }
